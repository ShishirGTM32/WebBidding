...
class CustomUserManager(BaseUserManager):
    ...
    def create_bidder(self, username, email, password, **extra_fields):
        ...
        BidderProfile.objects.create(user=user)  # Assuming you have this model
        return user
    ...
    def create_seller(self, username, email, password, **extra_fields):
        ...
        SellerProfile.objects.create(user=user)  # Assuming you have this model
        return user
...
class Bid(models.Model):
    ...
    total_bid_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    is_auction_ended = models.BooleanField(default=False)  # Add this field
